...
function JourneyNavItem({ id, topic, domain }: { id: string; topic: string; domain: string }) {
  ...
  return (
    <NavLink
      ...
      style={({ isActive }) => (isActive ? { background: 'rgba(124,156,255,0.14)' } : undefined)}
    >
...
export function Sidebar() {
  ...
  return (
    <aside className="w-[272px] flex-shrink-0 border-r border-border-soft bg-panel p-5">
      ...
      <div className="mb-2.5 mt-6 text-[11.5px] font-bold uppercase tracking-wide text-text-dim">Your journeys</div>
      ...
      <div className="mb-2.5 mt-6 text-[11.5px] font-bold uppercase tracking-wide text-text-dim">Practice</div>
